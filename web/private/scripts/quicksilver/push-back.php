...
$gitSecretsFile = "$privateFiles/.build-secrets/devops-tokens.json";
...
if (isset($buildProviders['git'])) {
    switch ($buildProviders['git']) {
       ...
       case 'azure':
            $upstreamRepoWithCredentials = str_replace('https://',"https://ccswds:$git_token@", $upstreamRepoWithCredentials);
	        break;
